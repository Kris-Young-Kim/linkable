...
export const translations = {
  ko: {
    ...
    "products.sortNameDesc": "이름순 (가나다 역순)",
    "products.sortPriceAsc": "가격 낮은순",
    "products.sortPriceDesc": "가격 높은순",
    "products.sortNewest": "최신순",
    "products.resultCount": "총 {count}개 제품",
    "products.resultCountNone": "제품이 없습니다",
    "products.loadMore": "더 보기",
    "products.clearFilters": "필터 초기화",
    "products.noResults": "검색 결과가 없습니다.",
    "products.noResultsHint": "다른 검색어나 카테고리를 시도해 보세요.",
    ...
    "errorFaq.quickSolutions": "빠른 해결 방법",
    "errorFaq.retry": "다시 시도",
    "errorFaq.reload": "페이지 새로고침",
  ...
  en: {
    ...
    "products.searchPlaceholder": "Search by name, description, category, or manufacturer",
    "products.searchLabel": "Search",
    "products.filterCategory": "Category",
    "products.filterManufacturer": "Manufacturer",
    "products.filterPrice": "Price range",
    "products.priceMin": "Min price",
    "products.priceMax": "Max price",
    "products.allCategories": "All categories",
    "products.allManufacturers": "All manufacturers",
    "products.sort": "Sort",
    ...
    "footer.languageLabel": "Choose language",
    "about.badge": "About LinkAble",
  ...
  ja: {
    ...
    "products.searchPlaceholder": "製品名・説明・カテゴリ・メーカーで検索",
    "products.searchLabel": "検索",
    "products.filterCategory": "カテゴリ",
    "products.filterManufacturer": "メーカー",
    "products.filterPrice": "価格帯",
    "products.priceMin": "最低価格",
    "products.priceMax": "最高価格",
    "products.allCategories": "すべてのカテゴリ",
    "products.allManufacturers": "すべてのメーカー",
    "products.sort": "並び替え",
    "products.sortNameAsc": "名前順 (あいうえお)",
    "products.sortNameDesc": "名前順 (逆)",
    "products.sortPriceAsc": "価格の安い順",
    "products.sortPriceDesc": "価格の高い順",
    "products.sortNewest": "新着順",
    "products.resultCount": "{count}件",
    "products.resultCountNone": "製品がありません",
    "products.loadMore": "もっと見る",
    "products.clearFilters": "フィルターをクリア",
    "products.noResults": "検索結果がありません。",
    "products.noResultsHint": "別のキーワードやカテゴリをお試しください。",
    "products.buyLink": "購入先を見る",
    "products.isoCode": "ISO分類",
    "products.backToHome": "ホームへ",
    "products.quickCategory": "人気カテゴリ",
