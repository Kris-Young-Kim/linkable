...
export const sampleProducts: ProductInput[] = [
  // ISO 18 30: 수직 접근성 보조기기 (경사로, 승강기)
  {
    ...
    purchase_link: "https://example.com/products/example1",
    price: 89000,
    category: "이동 보조",
    is_active: true,
  },
  {
    ...
    purchase_link: "https://example.com/products/example2",
    price: 45000,
    category: "이동 보조",
    is_active: true,
  },
  ...
  // ISO 15 09: 식사 및 음주 보조기기
  {
    ...
    purchase_link: "https://example.com/products/example3",
    price: 35000,
    category: "식사 보조",
    is_active: true,
  },
  {
    ...
    purchase_link: "https://example.com/products/example4",
    price: 65000,
    category: "식사 보조",
    is_active: true,
  },
  {
    ...
    purchase_link: "https://example.com/products/example5",
    price: 28000,
    category: "식사 보조",
    is_active: true,
  },
  ...
  // ISO 12 31: 체위 변경 보조기기
  {
    ...
    purchase_link: "https://example.com/products/example6",
    price: 1200000,
    category: "이동 보조",
    is_active: true,
  },
  {
    ...
    purchase_link: "https://example.com/products/example7",
    price: 850000,
    category: "이동 보조",
    is_active: true,
  },
  ...
  // ISO 12 06: 양팔 조작 보행 보조기기
  {
    ...
    purchase_link: "https://example.com/products/example8",
    price: 25000,
    category: "보행 보조",
    is_active: true,
  },
  {
    ...
    purchase_link: "https://example.com/products/example9",
    price: 95000,
    category: "보행 보조",
    is_active: true,
  },
  {
    ...
    purchase_link: "https://example.com/products/example10",
    price: 45000,
    category: "보행 보조",
    is_active: true,
  },
  ...
  // ISO 30 03: 놀이 보조기기
  {
    ...
    purchase_link: "https://example.com/products/example11",
    price: 55000,
    category: "인지 재활",
    is_active: true,
  },
  {
    ...
    purchase_link: "https://example.com/products/example12",
    price: 78000,
    category: "인지 재활",
    is_active: true,
  },
  ...
  // ISO 18 18: 지지 손잡이 및 그랩바
  {
    ...
    purchase_link: "https://example.com/products/example13",
    price: 35000,
    category: "안전 시설",
    is_active: true,
  },
  // ISO 09 33: 세면, 목욕 및 샤워 보조기기
  {
    ...
    purchase_link: "https://example.com/products/example14",
    price: 65000,
    category: "욕실 보조",
    is_active: true,
  },
  // ISO 18 33: 가정 및 기타 건물의 안전 장비
  {
    ...
    purchase_link: "https://example.com/products/example15",
    price: 120000,
    category: "안전 시설",
    is_active: true,
  },
  // ISO 18 09: 착석용 가구
  {
    ...
    purchase_link: "https://example.com/products/example16",
    price: 45000,
    category: "안전 시설",
    is_active: true,
  },
  // ISO 06 06: 상지 보조기
  {
    ...
    purchase_link: "https://example.com/products/example17",
    price: 18000,
    category: "보호 장비",
    is_active: true,
  },
  // ISO 06 12: 하지 보조기
  {
    ...
    purchase_link: "https://example.com/products/example18",
    price: 22000,
    category: "보호 장비",
    is_active: true,
  },
  // ISO 18 12: 침대 및 침대 장비
  {
    ...
    purchase_link: "https://example.com/products/example19",
    price: 55000,
    category: "안전 시설",
    is_active: true,
  },
  // ISO 04 48: 운동, 근력, 균형 및 심폐 훈련 장비
  {
    ...
    purchase_link: "https://example.com/products/example20",
    price: 68000,
    category: "재활 도구",
    is_active: true,
  },
  // ISO 04 48: 운동, 근력, 균형 및 심폐 훈련 장비
  {
    ...
    purchase_link: "https://example.com/products/example21",
    price: 450000,
    category: "보행 보조",
    is_active: true,
  },
  // ISO 06 06: 상지 보조기
  {
    ...
    purchase_link: "https://example.com/products/example22",
    price: 180000,
    category: "의료 보조기",
    is_active: true,
  },
  // ISO 06 12: 하지 보조기
  {
    ...
    purchase_link: "https://example.com/products/example23",
    price: 220000,
    category: "의료 보조기",
    is_active: true,
  },
  // ISO 12 23: 전동 휠체어
  {
    ...
    purchase_link: "https://example.com/products/example24",
    price: 1500000,
    category: "이동 보조",
    is_active: true,
  },
  // ISO 12 22: 수동 휠체어
  {
    ...
    purchase_link: "https://example.com/products/example25",
    price: 350000,
    category: "이동 보조",
    is_active: true,
  },
  // ISO 18 18: 지지 손잡이 및 그랩바
  {
    ...
    purchase_link: "https://example.com/products/example26",
    price: 45000,
    category: "안전 시설",
    is_active: true,
  },
  // ISO 18 30: 수직 접근성 보조기기
  {
    ...
    purchase_link: "https://example.com/products/example27",
    price: 2500000,
    category: "이동 보조",
    is_active: true,
  },
  // ISO 18 33: 가정 및 기타 건물의 안전 장비
  {
    ...
    purchase_link: "https://example.com/products/example28",
    price: 25000,
    category: "욕실 보조",
    is_active: true,
  },
  // ISO 12 31: 체위 변경 보조기기
  {
    ...
    purchase_link: "https://example.com/products/example29",
    price: 450000,
    category: "이동 보조",
    is_active: true,
  },
  // ISO 04 48: 운동, 근력, 균형 및 심폐 훈련 장비
  {
    ...
    purchase_link: "https://example.com/products/example30",
    price: 35000,
    category: "재활 도구",
    is_active: true,
  },
