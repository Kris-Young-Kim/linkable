...
export const icfCoreSet: IcfCode[] = [
  // 신체 기능 (Body Functions) - b2xx: 감각 기능
  {
    ...
    description: "시각 기능",
    category: "b",
    isoHints: ["22 03", "22 06"],
  },
  {
    code: "b215",
    description: "시각 관련 기능",
    category: "b",
    isoHints: ["22 03"],
  },
  {
  ...
  {
    code: "b164",
    description: "고등 인지 기능",
    category: "b",
    isoHints: ["04 03", "22 33"],
  },
  {
    code: "b167",
    description: "언어 정신 기능",
    category: "b",
    isoHints: ["22 30"],
  },
  ...
  {
    code: "b710",
    description: "관절 이동성 기능",
    category: "b",
    isoHints: ["06 03", "12 31"],
  },
  {
    code: "b715",
    description: "관절 안정성 기능",
    category: "b",
    isoHints: ["06 03"],
  },
  {
    code: "b720",
    description: "관절 이동 범위 기능",
    category: "b",
    isoHints: ["06 03"],
  },
  {
  ...
  {
    code: "b760",
    description: "수의적 운동 조절 기능",
    category: "b",
    isoHints: ["12 03", "15 09"],
  },
  {
    code: "b765",
    description: "불수의적 운동 조절(손 떨림)",
    category: "b",
    isoHints: ["15 09 13"],
  },
  {
    code: "b770",
    description: "보행 패턴 기능",
    category: "b",
    isoHints: ["12 06", "12 08"],
  },
  ...
  },
  {
    ...
    description: "청취(듣기)",
    category: "d",
    isoHints: ["21 06", "22 30"],
  },
  {
    code: "d120",
    description: "다른 감각을 통한 목적 지향적 경험",
    category: "d",
  },
  ...
  {
    code: "d310",
    description: "구어 메시지 이해",
    category: "d",
    isoHints: ["22 30"],
  },
  {
    code: "d315",
    description: "비구어 메시지 이해",
    category: "d",
    isoHints: ["22 30"],
  },
  {
    code: "d320",
    description: "구어 메시지 표현",
    category: "d",
    isoHints: ["22 30", "21 09"],
  },
  {
    code: "d325",
    description: "비구어 메시지 표현",
    category: "d",
    isoHints: ["22 30"],
  },
  ...
  {
    code: "d410",
    description: "서기/앉기/무릎꿇기",
    category: "d",
    isoHints: ["18 30 06", "12 31"],
  },
  {
    code: "d415",
    description: "안정한 자세 유지하기",
    category: "d",
    isoHints: ["12 31", "18 09"],
  },
  {
    code: "d420",
    description: "체위 변경하기",
  ...
  },
  {
    ...
    description: "걷기",
    category: "d",
    isoHints: ["12 02", "12 03", "12 06", "18 12 10"],
  },
  {
    code: "d455",
    description: "이동하기",
    category: "d",
    isoHints: ["12 22", "12 23"],
  },
  {
    code: "d460",
    description: "다양한 장소로 이동하기",
    category: "d",
    isoHints: ["12 22", "12 23", "18 30"],
  },
  {
    code: "d465",
    description: "이동 보조기기 사용하여 이동하기",
    category: "d",
    isoHints: ["12 22", "12 23"],
  },
  ...
  {
    code: "e110",
    description: "집 안 구조(바닥, 문턱)",
    category: "e",
    isoHints: ["18 24", "18 30"],
  },
  { code: "e115", description: "일상 생활용 제품 및 기술", category: "e" },
  {
    code: "e120",
    description: "건축 환경(계단, 경사로)",
    category: "e",
    isoHints: ["18 12 10", "18 30"],
  },
  {
    code: "e125",
    description: "의사소통용 제품 및 기술",
    category: "e",
    isoHints: ["22 30"],
  },
  {
    code: "e130",
    description: "교육용 제품 및 기술",
    category: "e",
    isoHints: ["22 33"],
  },
  {
    code: "e135",
    description: "직업용 제품 및 기술",
    category: "e",
    isoHints: ["28 03"],
  },
  {
    code: "e140",
    description: "문화, 레크리에이션 및 스포츠용 제품 및 기술",
    category: "e",
    isoHints: ["30 03", "30 09"],
  },
  {
    code: "e145",
    description: "종교 및 영성 실천용 제품 및 기술",
    category: "e",
  },
  { code: "e150", description: "디자인/제품", category: "e" },
  {
    code: "e155",
    description: "건축물 설계, 건설 및 건물 제품",
    category: "e",
    isoHints: ["18 24", "18 30"],
  },
  ...
  { code: "e225", description: "기후", category: "e" },
  {
    ...
    description: "빛",
    category: "e",
    isoHints: ["18 06", "22 03"],
  },
  {
    code: "e250",
    description: "소음",
    category: "e",
    isoHints: ["21 06", "27 03"],
  },
  ...
  {
    code: "e325",
    description: "동료, 동등한 사람 및 동료의 지원",
    category: "e",
  },
...
const getDefaultDescription = (code: string, category: IcfCategory): string => {
  ...
  // 주요 코드 범위별 세부 설명
  if (category === "b") {
    if (codeNum.startsWith("1"))
      return `${categoryNames.b} - 정신 기능 (${code})`;
    if (codeNum.startsWith("2"))
      return `${categoryNames.b} - 감각 기능 (${code})`;
    if (codeNum.startsWith("3"))
      return `${categoryNames.b} - 음성 및 말 기능 (${code})`;
    if (codeNum.startsWith("4"))
      return `${categoryNames.b} - 심혈관, 혈액, 면역 및 호흡 기능 (${code})`;
    if (codeNum.startsWith("5"))
      return `${categoryNames.b} - 소화, 대사 및 내분비 기능 (${code})`;
    if (codeNum.startsWith("6"))
      return `${categoryNames.b} - 비뇨생식 및 생식 기능 (${code})`;
    if (codeNum.startsWith("7"))
      return `${categoryNames.b} - 신경근골격 및 운동 관련 기능 (${code})`;
    if (codeNum.startsWith("8"))
      return `${categoryNames.b} - 피부 및 관련 구조 기능 (${code})`;
  } else if (category === "d") {
    if (codeNum.startsWith("1"))
      return `${categoryNames.d} - 학습 및 지식 적용 (${code})`;
    if (codeNum.startsWith("2"))
      return `${categoryNames.d} - 일반적인 과제와 요구사항 (${code})`;
    if (codeNum.startsWith("3"))
      return `${categoryNames.d} - 의사소통 (${code})`;
    if (codeNum.startsWith("4")) return `${categoryNames.d} - 이동 (${code})`;
    if (codeNum.startsWith("5"))
      return `${categoryNames.d} - 자가관리 (${code})`;
    if (codeNum.startsWith("6"))
      return `${categoryNames.d} - 가정생활 (${code})`;
    if (codeNum.startsWith("7"))
      return `${categoryNames.d} - 대인관계 상호작용 (${code})`;
    if (codeNum.startsWith("8"))
      return `${categoryNames.d} - 주요 생활 영역 (${code})`;
    if (codeNum.startsWith("9"))
      return `${categoryNames.d} - 여가 및 레크리에이션 (${code})`;
  } else if (category === "e") {
    if (codeNum.startsWith("1"))
      return `${categoryNames.e} - 제품 및 기술 (${code})`;
    if (codeNum.startsWith("2"))
      return `${categoryNames.e} - 자연 환경 및 인간이 만든 환경 변화 (${code})`;
    if (codeNum.startsWith("3"))
      return `${categoryNames.e} - 지원 및 관계 (${code})`;
    if (codeNum.startsWith("4")) return `${categoryNames.e} - 태도 (${code})`;
    if (codeNum.startsWith("5"))
      return `${categoryNames.e} - 서비스, 체계 및 정책 (${code})`;
  }
 ...
 * ICF 코드 조회 (동적 처리 지원)
 *
 * Full ICF 코드를 모두 사용하므로 Core Set 체크 없이
 * 기본 정보를 동적으로 생성하여 반환합니다.
 *
 * 실제 상세 정보는 findIcfCodeAsync에서 데이터베이스 조회합니다.
 *
...
export const findIcfCode = (code: string): IcfCode | null => {
  ...
  // 하위 호환성을 위해 Core Set에서 먼저 확인 (fallback)
  const found = icfCoreSet.find(
  ...
  // 동적으로 기본 정보 생성
  // 실제 상세 정보는 findIcfCodeAsync에서 데이터베이스 조회
  return {
...
/**
 * ICF 코드 조회 (비동기, Full catalog 사용)
 *
 * Full ICF 코드를 모두 사용하므로 데이터베이스에서 직접 조회합니다.
 *
 * @param code ICF 코드
...
export async function findIcfCodeAsync(
  ...
  if (supabase) {
    try {
      const { data: icfCode } = await supabase
        .from("icf_codes")
        .select("code, name, name_en, description, category")
        .eq("code", code.toLowerCase())
        .eq("is_active", true)
        .maybeSingle();

      if (icfCode) {
        // ISO 힌트는 icf_iso_mappings 테이블에서 조회
        ...
        try {
          ...
          if (mappings && mappings.length > 0) {
            isoHints = mappings.map((m: any) => m.iso_code);
          }
        } catch (error) {
          // ISO 힌트 조회 실패는 무시 (선택적 정보)
          console.log(
            `[findIcfCodeAsync] ISO hints lookup skipped for ${code}`
          );
        }
        ...
        return {
          ...
          description:
            ...
            getDefaultDescription(
              code,
              (icfCode.category as IcfCategory) || inferCategory(code) || "b"
            ),
          category:
            (icfCode.category as IcfCategory) || inferCategory(code) || "b",
          isoHints,
      ...
      console.error(
        `[findIcfCodeAsync] Database lookup failed for ${code}:`,
        error
      );
  ...
  // 데이터베이스 조회 실패하거나 supabase가 없으면 기본 정보 반환 (fallback)
  return findIcfCode(code);
}

/**
 * ICF 코드가 Core Set에 포함되어 있는지 확인
 *
 * @deprecated Full ICF 코드를 모두 사용하므로 이 함수는 더 이상 의미가 없습니다.
 *             하위 호환성을 위해 유지되지만 항상 false를 반환합니다.
 */
 ...
 *
 * @deprecated Full ICF 코드를 모두 사용하므로 이 함수는 더 이상 의미가 없습니다.
 *             하위 호환성을 위해 유지되지만 빈 배열을 반환합니다.
 */
export const getMissingCodes = (codes: string[]): string[] => {
  // Full catalog 사용으로 인해 모든 코드가 사용 가능
  return [];
};
