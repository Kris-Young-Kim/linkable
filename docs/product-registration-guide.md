...
### ISO 9999:2022 전체 카테고리

**중요**: 이제 ISO 9999:2022의 **전체 카테고리**가 열려있습니다. ICF 매핑이 없어도 모든 ISO 코드를 선택할 수 있습니다.

제품 등록 시 ISO 코드 선택 드롭다운에서:
- **검색 기능**: ISO 코드, 분류명, 설명으로 검색 가능
- **클래스별 그룹화**: 클래스별로 그룹화되어 표시
- **전체 카테고리**: 약 50개 이상의 ISO 코드 제공
...
**전체 ISO 코드 목록**은 제품 등록 페이지의 ISO 코드 선택 드롭다운에서 확인할 수 있습니다.
