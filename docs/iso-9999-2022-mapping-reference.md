...
- **Class 레벨 (대분류)**: `04`, `06`, `09`, `12`, `15`, `18`, `22`, `24`, `27`, `28`, `30` (2자리)
- **Subclass 레벨 (중분류)**: `12 22`, `15 09`, `18 30` (4자리)
- **Division 레벨 (소분류)**: `12 22 01`, `15 09 13`, `18 30 01` (6자리)
- **표시 형식**: `12`, `15 09`, `18 30` (공백 포함, 가독성 향상)

## 제품 배정 레벨

**현재 시스템은 Division 레벨(소분류, level=3)에서 제품을 배정합니다.**

- **Class 레벨 (대분류)**: 2자리 코드 (예: `12`, `15`, `22`)
  - 가장 상위 분류 레벨
  - 제품 배정에는 사용하지 않음 (참고용)
- **Subclass 레벨 (중분류)**: 4자리 코드 (예: `12 22`, `15 09`, `18 30`)
  - Class의 하위 분류
  - 제품 배정에는 사용하지 않음 (참고용)
- **Division 레벨 (소분류)**: 6자리 코드 (예: `12 22 01`, `15 09 13`, `18 30 01`)
  - Subclass의 하위 분류
  - **제품은 Division 레벨에 직접 배정됨**
  - 가장 세분화된 분류 레벨
